                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <img src="{{ $user->profile->avatar ?? 'https://placehold.co/100x100' }}" class="img-thumbnail mb-2"
                                    alt="Avatar">
                                <div class="roles">
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <img src="{{ $user->avatar ?? 'https://placehold.co/100x100' }}" class="img-thumbnail mb-2"
                                    alt="Avatar">
